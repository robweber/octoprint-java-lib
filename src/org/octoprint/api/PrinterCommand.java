...
public class PrinterCommand extends OctoPrintCommand {
	...
	/**
	 * Provides information about the current print job.
	 *
	 * @return current print job
	 */
	public OctoPrintJob getCurrentJob() {
	...
	/**
	 * Performs job operations like starting or pausing on the current print job.
	 *
	 * @param command the command to send
	 * @return if this operation succeeded
	 */
	public boolean sendJobCommand(JobState command){
		JSONObject params = new JSONObject();
		params.put("command",command.getState());
		return this.sendCommand("job",params);
	}
